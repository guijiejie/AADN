...
class Options():
    def __init__(self):
        ...
        self.parser.add_argument('--only_residual', type=bool, default=False, help='regress residual rather than image')
        self.parser.add_argument('--inc', type=int, default=3)
        self.parser.add_argument('--outc', type=int, default=3)
        ...
        self.parser.add_argument("--loss_per", type=bool)

        self.parser.add_argument('--num_workers', type=int, default=4)
        self.parser.add_argument("--img_w", type=int)
        self.parser.add_argument("--img_h", type=int)
        self.parser.add_argument("--g_lr", type=float, default=0.0002)
